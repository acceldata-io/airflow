...
#   <daily-build>  = the full build version, e.g. 3.2.3.701-2009
#   <release-line> = the stable release, e.g. 3.2.3.701-2
...
# here is already the daily value (e.g. 3.2.3.701-2009). The daily build number is always
# the release build number plus a 3-digit sequence, so the release line is the daily
# with those last 3 digits stripped (3.2.3.701-2009 -> 3.2.3.701-2). It's assembled at
...
SPARK3_DAILY_BUILD="${ODP_VERSION}"                 # e.g. 3.2.3.701-2009
SPARK3_RELEASE_LINE="${SPARK3_DAILY_BUILD%???}"     # strip 3-digit daily seq -> 3.2.3.701-2
