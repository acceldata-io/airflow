...
Airflow so far (till JAN 2025 ) used tarballs hosted at [common tarballs](https://mirror-stg.odp.acceldata.dev/ODP/PY-UTILS/) for all releases till 3.3.6.2-1 and 3.2.3.4-2/3. which was not the best decision cause if a cve is to be fixed, or a new feature there is no documentation or steps to recreate that tarball. this is my attempt to make airflow tarballs easy and clean way to build.
